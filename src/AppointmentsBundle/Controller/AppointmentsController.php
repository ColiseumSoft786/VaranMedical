...
class AppointmentsController extends Controller
{
    ...
    public function indexAction($id)
    {
        ...
        $comments = $em->getRepository('DataBundle:Comments')->findBy(array('location'=>$location[0]->getId()));
    ...
    public function confirmtoggleAction($id){
        $em = $this->getDoctrine()->getManager();
        $app = $em->getRepository('DataBundle:Appointments')->findOneBy(array('seance' => $id));
