 ...
 */
class Reasons extends \AppointmentsBundle\Entity\Reasons implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppointmentsBundle\\Entity\\Reasons' . "\0" . 'id', '' . "\0" . 'AppointmentsBundle\\Entity\\Reasons' . "\0" . 'reason', '' . "\0" . 'AppointmentsBundle\\Entity\\Reasons' . "\0" . 'appointments'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Reasons $proxy) {
