 ...
 */
class Reasons extends \DataBundle\Entity\Reasons implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\Reasons' . "\0" . 'reason', '' . "\0" . 'DataBundle\\Entity\\Reasons' . "\0" . 'id'];
        }
