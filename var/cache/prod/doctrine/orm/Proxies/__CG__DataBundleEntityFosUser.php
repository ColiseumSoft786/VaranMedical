 ...
 */
class FosUser extends \DataBundle\Entity\FosUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'username', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'usernameCanonical', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'email', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'emailCanonical', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'enabled', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'salt', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'password', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'lastLogin', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'confirmationToken', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'passwordRequestedAt', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'roles', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'typeuser', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'idtable', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'verifier', '' . "\0" . 'DataBundle\\Entity\\FosUser' . "\0" . 'id'];
        }
