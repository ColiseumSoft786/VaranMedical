 ...
 */
class Calendries extends \DataBundle\Entity\Calendries implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'deleatedat', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'date', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'public', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'absence', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'id', '' . "\0" . 'DataBundle\\Entity\\Calendries' . "\0" . 'location'];
        }
