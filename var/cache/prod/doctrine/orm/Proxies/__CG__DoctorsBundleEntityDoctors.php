...
class Doctors extends \DoctorsBundle\Entity\Doctors implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'id', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'firstName', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'lastName', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'birthday', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'GSM', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'title', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'professionalStatement', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'settings', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'education', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'hopitaux', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'certifications', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'invoices', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'location', '' . "\0" . 'DoctorsBundle\\Entity\\Doctors' . "\0" . 'specialities'];
        }
