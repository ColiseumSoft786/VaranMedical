...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'typeUser', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'idTable', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'appointments', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'photos', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'verifier', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
