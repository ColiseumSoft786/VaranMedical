 ...
 */
class SubServices extends \DoctorsBundle\Entity\SubServices implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'DoctorsBundle\\Entity\\SubServices' . "\0" . 'id', '' . "\0" . 'DoctorsBundle\\Entity\\SubServices' . "\0" . 'subService', '' . "\0" . 'DoctorsBundle\\Entity\\SubServices' . "\0" . 'service', '' . "\0" . 'DoctorsBundle\\Entity\\SubServices' . "\0" . 'invoices'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SubServices $proxy) {
    ...
    public function setSubService($subService)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubService', [$subService]);

        return parent::setSubService($subService);
    }
    ...
    public function getSubService()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubService', []);

        return parent::getSubService();
    }
